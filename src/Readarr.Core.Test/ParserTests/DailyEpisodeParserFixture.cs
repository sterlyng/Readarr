...
namespace Readarr.Core.Test.ParserTests
{
    ...
    public class DailyEpisodeParserFixture : CoreTest
    {
        ...
        [TestCase("Series.Title.2015.09.07.Part1.720p.HULU.WEBRip.AAC2.0.H.264-Readarr", "Series Title", 2015, 9, 7, 1)]
        [TestCase("Series.Title.2015.09.07.Part2.720p.HULU.WEBRip.AAC2.0.H.264-Readarr", "Series Title", 2015, 9, 7, 2)]
        [TestCase("Series.Title.2015.09.07.Part.1.720p.HULU.WEBRip.AAC2.0.H.264-Readarr", "Series Title", 2015, 9, 7, 1)]
        [TestCase("Series.Title.2015.09.07.Part.2.720p.HULU.WEBRip.AAC2.0.H.264-Readarr", "Series Title", 2015, 9, 7, 2)]
