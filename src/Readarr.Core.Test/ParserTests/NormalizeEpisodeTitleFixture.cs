...
namespace Readarr.Core.Test.ParserTests
{
    ...
    public class NormalizeEpisodeTitleFixture : CoreTest
    {
        ...
        [TestCase("Series.Title.S01.Special.Episode.Title.720p.HDTV.x264-Readarr", "episode title")]
        [TestCase("Series.Title.S01E00.Episode.Title.720p.HDTV.x264-Readarr", "episode title")]
