...
namespace Readarr.Core.Test.ParserTests
{
    ...
    public class ReleaseGroupParserFixture : CoreTest
    {
        ...
        [TestCase("Who.is.Readarr.S01E01.INTERNAL.720p.HDTV.x264-aAF-RakuvUS-Obfuscated", "aAF")]
        [TestCase("Deadly.Development.S01E10.Sink.With.Code.1080p.AMZN.WEB-DL.DDP5.1.H.264-NTG-WhiteRev", "NTG")]
        [TestCase("The.Readarr.Series.S09E12.Developers.REPACK.1080p.AMZN.WEB-DL.DD.5.1.H.264-CasStudio-BUYMORE", "CasStudio")]
        ...
        [TestCase("Absolute.Series.S02E06.The.House.of.Readarr.DVDRip.x264-MaG-Chamele0n", "MaG")]
        ...
        [TestCase("[FFF] Series Title!! - S01E11 - Someday, With Readarr", "FFF")]
        [TestCase("[HorribleSubs] Series Title!! - S01E12 - Readarr Going Well!!", "HorribleSubs")]
        [TestCase("[Anime-Koi] Series Title - S01E06 - Guys From Readarr", "Anime-Koi")]
        [TestCase("[Anime-Koi] Series Title - S01E07 - A High-Grade Readarr", "Anime-Koi")]
