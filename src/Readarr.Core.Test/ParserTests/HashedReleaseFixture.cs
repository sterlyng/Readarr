...
namespace Readarr.Core.Test.ParserTests
{
    ...
    public class HashedReleaseFixture : CoreTest
    {
        public static object[] HashedReleaseParserCases =
        {
            ...
            new object[]
            {
                @"C:\Test\Title.S01E10.DVDRip.XviD-Readarr\AHFMZXGHEWD660.mkv".AsOsAgnostic(),
                "Title",
                Quality.DVD,
                "Readarr"
            },
            new object[]
            {
                @"C:\Test\Show Title.S02E12.1080p.BluRay.x264-Readarr\Backup_72023S02-12.mkv".AsOsAgnostic(),
                "Show Title",
                Quality.Bluray1080p,
                "Readarr"
            },
