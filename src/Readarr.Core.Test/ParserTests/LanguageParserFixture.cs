...
namespace Readarr.Core.Test.ParserTests
{
    ...
    public class LanguageParserFixture : CoreTest
    {
        ...
        [TestCase("The Final Readarr (2020) S04 Complete 720p NF WEBRip [Hindi] Dual audio")]
        ...
        [TestCase("The Final Readarr (2020) S04 Complete 720p NF WEBRip [Hindi+English] Dual audio")]
