        ...
        public void should_convert_single_episode_without_folder()
        {
            var db = WithMigrationTestDb(c =>
            {
                c.Insert.IntoTable("EpisodeFiles").Row(new
                {
                    ...
                    OriginalFilePath = "Series.Title.S01E05.720p.HDTV.x265-Readarr.mkv",
        ...
        public void should_convert_single_episode_with_folder()
        {
            var db = WithMigrationTestDb(c =>
            {
                c.Insert.IntoTable("EpisodeFiles").Row(new
                {
                    ...
                    Size = 125.Megabytes(),
                    DateAdded = DateTime.UtcNow.AddDays(-5),
                    OriginalFilePath = "Series.Title.S01E05.720p.HDTV.x265-Readarr/S01E05.mkv",
                    ReleaseGroup = "Readarr",
                    Quality = new QualityModel(Quality.HDTV720p).ToJson(),
                    Languages = "[1]"
                });
        ...
        public void should_convert_multi_episode_without_folder()
        {
            var db = WithMigrationTestDb(c =>
            {
                c.Insert.IntoTable("EpisodeFiles").Row(new
                {
                    ...
                    Size = 125.Megabytes(),
                    DateAdded = DateTime.UtcNow.AddDays(-5),
                    OriginalFilePath = "Series.Title.S01E05E06.720p.HDTV.x265-Readarr.mkv",
                    ReleaseGroup = "Readarr",
                    Quality = new QualityModel(Quality.HDTV720p).ToJson(),
                    Languages = "[1]"
                });
        ...
        public void should_convert_multi_episode_with_folder()
        {
            var db = WithMigrationTestDb(c =>
            {
                c.Insert.IntoTable("EpisodeFiles").Row(new
                {
                    ...
                    Size = 125.Megabytes(),
                    DateAdded = DateTime.UtcNow.AddDays(-5),
                    OriginalFilePath = "Series.Title.S01E05E06.720p.HDTV.x265-Readarr/S01E05E06.mkv",
                    ReleaseGroup = "Readarr",
                    Quality = new QualityModel(Quality.HDTV720p).ToJson(),
                    Languages = "[1]"
                });
        ...
        public void should_convert_season_pack_with_folder()
        {
            var db = WithMigrationTestDb(c =>
            {
                c.Insert.IntoTable("EpisodeFiles").Row(new
                {
                    ...
                    Size = 125.Megabytes(),
                    DateAdded = DateTime.UtcNow.AddDays(-5),
                    OriginalFilePath = "Series.Title.S01.720p.HDTV.x265-Readarr/S01E05.mkv",
                    ReleaseGroup = "Readarr",
                    Quality = new QualityModel(Quality.HDTV720p).ToJson(),
                    Languages = "[1]"
                });
