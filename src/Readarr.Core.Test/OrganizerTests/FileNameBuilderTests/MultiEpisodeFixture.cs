...
namespace Readarr.Core.Test.OrganizerTests.FileNameBuilderTests
{
    ...
    public class MultiEpisodeFixture : CoreTest<FileNameBuilder>
    {
        ...
        public void Setup()
        {
            ...
            _episodeFile = new EpisodeFile { Quality = new QualityModel(Quality.HDTV720p), ReleaseGroup = "ReadarrTest" };
        ...
        public void should_get_proper_filename_when_multi_episode_is_duplicated_and_bracket_follows_pattern()
        {
            ...
            Subject.BuildFileName(new List<Episode> { _episode1, _episode2 }, _series, _episodeFile)
                   .Should().Be("South Park - S15E06 - S15E07 - (HDTV-720p, , ReadarrTest) - City Sushi");
        }
