...
namespace Readarr.Update.Test
{
   ...
   public class UpdateProviderStartFixture : TestBase
    {
        private const string UPDATE_FOLDER = @"C:\Temp\Readarr_update\Readarr\";
        private const string BACKUP_FOLDER = @"C:\Temp\Readarr_update\Readarr_backup\";
        private const string TARGET_FOLDER = @"C:\Readarr\";
        ...
        [Test]
        public void should_stop_Readarr_service_if_installed_and_running()
        {
        ...
        [Test]
        public void should_not_stop_Readarr_service_if_installed_but_not_running()
        {
            WithInstalledService();
        ...
        [Test]
        public void should_not_stop_Readarr_service_if_service_isnt_installed()
        {
        ...
        [Test]
        public void should_kill_Readarr_process_if_running()
        {
            var processes = Builder<ProcessInfo>.CreateListOfSize(2).Build().ToList();

            Mocker.GetMock<IProcessProvider>()
                .Setup(c => c.GetProcessByName(ProcessProvider.ReadarrProcessName))
                .Returns(processes);
            ...
            Mocker.GetMock<IProcessProvider>().Verify(c => c.KillAll(ProcessProvider.ReadarrProcessName), Times.Once());
        }

        [Test]
        public void should_not_kill_Readarr_process_not_running()
        {
            Mocker.GetMock<IProcessProvider>()
                .Setup(c => c.GetProcessByName(ProcessProvider.ReadarrProcessName))
        ...
        private void VerifyProcessRestart()
        {
            ...
            Mocker.GetMock<IProcessProvider>()
                .Verify(c => c.Start(TARGET_FOLDER + "Readarr.exe"), Times.Once());
        }
