...
namespace Readarr.Common.Instrumentation
{
    public static class ReadarrLogger
    {
        ...
        private static void RegisterSentry(bool updateClient, IAppFolderInfo appFolderInfo)
        {
            ...
            if (updateClient)
            {
                dsn = RuntimeInfo.IsProduction
                    ? "https://80777986b95f44a1a90d1eb2f3af1e36@sentry.Readarr.tv/11"
                    : "https://6168f0946aba4e60ac23e469ac08eac5@sentry.Readarr.tv/9";
            }
            else
            {
                dsn = RuntimeInfo.IsProduction
                    ? "https://e2adcbe52caf46aeaebb6b1dcdfe10a1@sentry.Readarr.tv/8"
                    : "https://4ee3580e01d8407c96a7430fbc953512@sentry.Readarr.tv/10";
            }
        ...
        private static void RegisterConsole()
        {
            ...
            var logFormat = Enum.TryParse<ConsoleLogFormat>(Environment.GetEnvironmentVariable("Readarr__LOG__CONSOLEFORMAT"), out var formatEnumValue)
                ? formatEnumValue
        ...
        private static void RegisterGlobalFilters()
        {
            LogManager.Setup().LoadConfiguration(c =>
            {
                ...
                c.ForLogger("Readarr.Http.Authentication.ApiKeyAuthenticationHandler").WriteToNil(LogLevel.Info);
            });
        }

        public static Logger GetLogger(Type obj)
        {
            return LogManager.GetLogger(obj.Name.Replace("Readarr.", ""));
        }
