        ...
        public AppFolderInfo(IStartupContext startupContext)
        {
            ...
            else
            {
                ...
                LegacyAppDataFolder = OsInfo.IsOsx
                    ? Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile, Environment.SpecialFolderOption.DoNotVerify), ".config", "Readarr")
                    : Path.Combine(Environment.GetFolderPath(_dataSpecialFolder, Environment.SpecialFolderOption.DoNotVerify), "Readarr");
            }
