...
namespace Readarr.Core.Notifications.Discord
{
    public class Discord : NotificationBase<DiscordSettings>
    {
        ...
        public ValidationFailure TestMessage()
        {
            ...
            {
                return new ReadarrValidationFailure(string.Empty, _localizationService.GetLocalizedString("NotificationsValidationUnableToSendTestMessage", new Dictionary<string, object> { { "exceptionMessage", ex.Message } }));
            }
