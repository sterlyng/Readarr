...
namespace Readarr.Core.Notifications
{
        ...
        where TSettings : NotificationSettingsBase<TSettings>, new()
    {
        ...
        protected const string EPISODE_GRABBED_TITLE_BRANDED = "Readarr - " + EPISODE_GRABBED_TITLE;
        protected const string EPISODE_DOWNLOADED_TITLE_BRANDED = "Readarr - " + EPISODE_DOWNLOADED_TITLE;
        protected const string IMPORT_COMPLETE_TITLE_BRANDED = "Readarr - " + IMPORT_COMPLETE_TITLE;
        protected const string EPISODE_DELETED_TITLE_BRANDED = "Readarr - " + EPISODE_DELETED_TITLE;
        protected const string SERIES_ADDED_TITLE_BRANDED = "Readarr - " + SERIES_ADDED_TITLE;
        protected const string SERIES_DELETED_TITLE_BRANDED = "Readarr - " + SERIES_DELETED_TITLE;
