    ...
    public class Gotify : NotificationBase<GotifySettings>
    {
        ...
        public override ValidationResult Test()
        {
            ...
            try
            {
                ...
                sb.AppendLine("This is a test message from Readarr");
                ...
                if (Settings.IncludeSeriesPoster)
                {
                    ...
                    sb.AppendLine($"\r![]({ReadarrImageUrl})");
                    payload.SetImage(ReadarrImageUrl);
                }
                ...
                if (Settings.MetadataLinks.Any())
                {
                    ...
                    sb.AppendLine("");
                    sb.AppendLine("[Readarr.tv](https://Readarr.tv)");
                    payload.SetClickUrl("https://Readarr.tv");
                }
