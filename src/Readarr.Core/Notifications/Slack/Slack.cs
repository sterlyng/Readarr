...
namespace Readarr.Core.Notifications.Slack
{
    public class Slack : NotificationBase<SlackSettings>
    {
        ...
        public ValidationFailure TestMessage()
        {
            ...
            {
                return new ReadarrValidationFailure("Unable to post", _localizationService.GetLocalizedString("NotificationsValidationUnableToSendTestMessage", new Dictionary<string, object> { { "exceptionMessage", ex.Message } }));
            }
