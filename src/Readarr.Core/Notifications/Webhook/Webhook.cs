...
namespace Readarr.Core.Notifications.Webhook
{
    public class Webhook : WebhookBase<WebhookSettings>
    {
        ...
        private ValidationFailure SendWebhookTest()
        {
            ...
            {
                return new ReadarrValidationFailure("Url", _localizationService.GetLocalizedString("NotificationsValidationUnableToSendTestMessage", new Dictionary<string, object> { { "exceptionMessage", ex.Message } }));
            }
