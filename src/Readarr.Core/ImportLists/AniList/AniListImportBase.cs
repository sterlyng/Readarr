...
namespace Readarr.Core.ImportLists.AniList
{
    ...
    where TSettings : AniListSettingsBase<TSettings>, new()
    {
        ...
        public const string RedirectUri = "https://auth.servarr.com/v1/anilist_Readarr/auth";
        public const string RenewUri = "https://auth.servarr.com/v1/anilist_Readarr/renew";
