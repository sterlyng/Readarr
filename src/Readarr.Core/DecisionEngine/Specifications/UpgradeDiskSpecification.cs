...
namespace Readarr.Core.DecisionEngine.Specifications
{
    public class UpgradeDiskSpecification : IDownloadDecisionEngineSpecification
    {
        ...
        private DownloadSpecDecision CheckUpgradeSpecification(Readarr.Core.MediaFiles.EpisodeFile file, Readarr.Core.Profiles.Qualities.QualityProfile qualityProfile, RemoteEpisode subject)
        {
            if (file == null)
            {
