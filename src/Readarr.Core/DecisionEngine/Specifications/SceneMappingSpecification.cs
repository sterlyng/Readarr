    ...
    public class SceneMappingSpecification : IDownloadDecisionEngineSpecification
    {
        ...
        public DownloadSpecDecision IsSatisfiedBy(RemoteEpisode remoteEpisode, ReleaseDecisionInformation information)
        {
            ...
            if (split[0] == "unknown")
            {
                ...
                _logger.Debug("SceneMapping origin is explicitly unknown, unsure what numbering scheme it uses but '{0}' will be assumed. Provide full release title to Readarr/TheXEM team.", type);
            }
