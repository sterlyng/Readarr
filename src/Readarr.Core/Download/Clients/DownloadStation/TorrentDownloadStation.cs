    ...
    public class TorrentDownloadStation : TorrentClientBase<DownloadStationSettings>
    {
        ...
        protected ValidationFailure TestOutputPath()
        {
            try
            {
                ...
                if (downloadDir == null)
                {
                    return new ReadarrValidationFailure(nameof(Settings.TvDirectory), _localizationService.GetLocalizedString("DownloadClientDownloadStationValidationNoDefaultDestination"))
                    {
                ...
                {
                    return new ReadarrValidationFailure(fieldName, _localizationService.GetLocalizedString("DownloadClientDownloadStationValidationSharedFolderMissing"))
                    {
                ...
                if (!folderInfo.IsDir)
                {
                    return new ReadarrValidationFailure(fieldName, _localizationService.GetLocalizedString("DownloadClientDownloadStationValidationFolderMissing"))
                    {
            ...
            catch (DownloadClientAuthenticationException ex)
            {
                ...
                return new ReadarrValidationFailure(string.Empty, ex.Message);
            }
            catch (Exception ex)
            {
