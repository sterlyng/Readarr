    ...
    public class Sabnzbd : UsenetClientBase<SabnzbdSettings>
    {
        ...
        private ValidationFailure TestConnectionAndVersion()
        {
            try
            {
                ...
                {
                    return new ReadarrValidationFailure("Version", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationDevelopVersion"))
                    {
                        IsWarning = true,
        ...
        private ValidationFailure TestGlobalConfig()
        {
            ...
            {
                return new ReadarrValidationFailure("", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationCheckBeforeDownload"))
                {
        ...
        private ValidationFailure TestCategory()
        {
            ...
            if (category != null)
            {
                ...
                {
                    return new ReadarrValidationFailure("TvCategory", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationEnableJobFolders"))
                    {
            ...
            else
            {
                ...
                {
                    return new ReadarrValidationFailure("TvCategory", _localizationService.GetLocalizedString("DownloadClientValidationCategoryMissing"))
                    {
                        InfoLink = _proxy.GetBaseUrl(Settings, "config/categories/"),
            ...
            {
                return new ReadarrValidationFailure("TvCategory", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationEnableDisableTvSorting"))
                {
            ...
            {
                return new ReadarrValidationFailure("TvCategory", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationEnableDisableMovieSorting"))
                {
                    InfoLink = _proxy.GetBaseUrl(Settings, "config/sorting/"),
            ...
            {
                return new ReadarrValidationFailure("TvCategory", _localizationService.GetLocalizedString("DownloadClientSabnzbdValidationEnableDisableDateSorting"))
                {
                    InfoLink = _proxy.GetBaseUrl(Settings, "config/sorting/"),
