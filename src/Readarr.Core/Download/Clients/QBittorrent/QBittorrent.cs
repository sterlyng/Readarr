    ...
    public class QBittorrent : TorrentClientBase<QBittorrentSettings>
    {
        ...
        private ValidationFailure TestConnection()
        {
            try
            {
                ...
                if (version < Version.Parse("1.5"))
                {
                    ...
                    return new ReadarrValidationFailure("Host", _localizationService.GetLocalizedString("DownloadClientValidationErrorVersion",
                ...
                else if (version < Version.Parse("1.6"))
                {
                    ...
                    {
                        return new ReadarrValidationFailure("Category", _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationCategoryUnsupported"))
                        {
                ...
                else if (Settings.TvCategory.IsNullOrWhiteSpace())
                {
                    ...
                    return new ReadarrValidationFailure("TvCategory", _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationCategoryRecommended"))
                    {
                        IsWarning = true,
                ...
                {
                    return new ReadarrValidationFailure(string.Empty, _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationRemovesAtRatioLimit"))
                    {
            ...
            catch (DownloadClientAuthenticationException ex)
            {
                ...
                return new ReadarrValidationFailure("Username", _localizationService.GetLocalizedString("DownloadClientValidationAuthenticationFailure"))
                {
            ...
            catch (WebException ex)
            {
                ...
                {
                    return new ReadarrValidationFailure("Host", _localizationService.GetLocalizedString("DownloadClientValidationUnableToConnect", new Dictionary<string, object> { { "clientName", Name } }))
                    {
                        DetailedDescription = _localizationService.GetLocalizedString("DownloadClientValidationUnableToConnectDetail")
                    };
                }

                return new ReadarrValidationFailure(string.Empty, _localizationService.GetLocalizedString("DownloadClientValidationUnknownException", new Dictionary<string, object> { { "exception", ex.Message } }));
            }
            catch (Exception ex)
            {
        ...
        private ValidationFailure TestCategory()
        {
            ...
            if (Settings.TvCategory.IsNotNullOrWhiteSpace() && !labels.ContainsKey(Settings.TvCategory))
            {
                ...
                {
                    return new ReadarrValidationFailure("TvCategory", _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationCategoryAddFailure"))
                    {
            ...
            if (Settings.TvImportedCategory.IsNotNullOrWhiteSpace() && !labels.ContainsKey(Settings.TvImportedCategory))
            {
                ...
                {
                    return new ReadarrValidationFailure("TvImportedCategory", _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationCategoryAddFailure"))
                    {
                        DetailedDescription = _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationCategoryAddFailureDetail")
                    };
                }
        ...
        private ValidationFailure TestPrioritySupport()
        {
            ...
            try
            {
                ...
                if (!config.QueueingEnabled)
                {
                    ...
                    {
                        return new ReadarrValidationFailure(nameof(Settings.RecentTvPriority), _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationQueueingNotEnabled"))
                        {
                    ...
                    {
                        return new ReadarrValidationFailure(nameof(Settings.OlderTvPriority), _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationQueueingNotEnabled"))
                        {
                            DetailedDescription = _localizationService.GetLocalizedString("DownloadClientQbittorrentValidationQueueingNotEnabledDetail")
                        };
                    }
        ...
        private ValidationFailure TestGetTorrents()
        {
            ...
            catch (Exception ex)
            {
                ...
                return new ReadarrValidationFailure(string.Empty, _localizationService.GetLocalizedString("DownloadClientValidationTestTorrents", new Dictionary<string, object> { { "exceptionMessage", ex.Message } }));
            }
