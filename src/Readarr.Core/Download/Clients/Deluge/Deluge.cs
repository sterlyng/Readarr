    ...
    public class Deluge : TorrentClientBase<DelugeSettings>
    {
        ...
        public override IEnumerable<DownloadClientItem> GetItems()
        {
            ...
            foreach (var torrent in torrents)
            {
                ...
                // This allows Readarr to delete the torrent as appropriate.
        ...
        private ValidationFailure TestConnection()
        {
            ...
            catch (DownloadClientAuthenticationException ex)
            {
                ...
                return new ReadarrValidationFailure("Password", _localizationService.GetLocalizedString("DownloadClientValidationAuthenticationFailure"));
            }
            catch (WebException ex)
            {
                ...
                switch (ex.Status)
                {
                    ...
                    case WebExceptionStatus.ConnectionClosed:
                        return new ReadarrValidationFailure("UseSsl", _localizationService.GetLocalizedString("DownloadClientValidationVerifySsl"))
                        {
                    ...
                    case WebExceptionStatus.SecureChannelFailure:
                        return new ReadarrValidationFailure("UseSsl", _localizationService.GetLocalizedString("DownloadClientValidationSslConnectFailure"))
                        {
        ...
        private ValidationFailure TestCategory()
        {
            ...
            {
                return new ReadarrValidationFailure("TvCategory", _localizationService.GetLocalizedString("DownloadClientDelugeValidationLabelPluginInactive"))
                {
            ...
            if (Settings.TvCategory.IsNotNullOrWhiteSpace() && !labels.Contains(Settings.TvCategory))
            {
                ...
                {
                    return new ReadarrValidationFailure("TvCategory", _localizationService.GetLocalizedString("DownloadClientDelugeValidationLabelPluginFailure"))
                    {
            ...
            if (Settings.TvImportedCategory.IsNotNullOrWhiteSpace() && !labels.Contains(Settings.TvImportedCategory))
            {
                ...
                {
                    return new ReadarrValidationFailure("TvImportedCategory", _localizationService.GetLocalizedString("DownloadClientDelugeValidationLabelPluginFailure"))
                    {
                        DetailedDescription = _localizationService.GetLocalizedString("DownloadClientDelugeValidationLabelPluginFailureDetail", new Dictionary<string, object> { { "clientName", Name } })
                    };
                }
