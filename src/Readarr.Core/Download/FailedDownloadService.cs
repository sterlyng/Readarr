    ...
    public class FailedDownloadService : IFailedDownloadService
    {
        ...
        public void Check(TrackedDownload trackedDownload)
        {
                ...
                trackedDownload.DownloadItem.Status == DownloadItemStatus.Failed)
            {
                ...
                {
                    trackedDownload.Warn(trackedDownload.DownloadItem.IsEncrypted ? "Download is encrypted and wasn't grabbed by Readarr, skipping automatic download handling" : "Download has failed wasn't grabbed by Readarr, skipping automatic download handling");
                    return;
                }
