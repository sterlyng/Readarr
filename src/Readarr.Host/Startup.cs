        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v3", new OpenApiInfo
                {
                    Version = "3.0.0",
                    Title = "Readarr",
                    Description = "Readarr API docs - The v3 API docs apply to both v3 and v4 versions of Readarr. Some functionality may only be available in v4 of the Readarr application.",
                ...
                c.SwaggerDoc("v5", new OpenApiInfo
                {
                    Version = "5.0.0",
                    Title = "Readarr",
                    Description = "Readarr API docs - The v5 API docs apply to Readarr v5 only.",
                    License = new OpenApiLicense
                    {
                        Name = "GPL-3.0",
                        Url = new Uri("https://github.com/Readarr/Readarr/blob/develop/LICENSE")
