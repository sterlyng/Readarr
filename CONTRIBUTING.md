...
5. Build the project in Visual Studio, Setting startup project to `Readarr.Console` and framework to `x86`
...
- Rebase from Readarr's `v5-develop` branch, don't merge
- Make meaningful commits, or squash them
- Feel free to make a pull request before work is complete, this will let us see where its at and make comments/suggest improvements
- Reach out to us on our [forums](https://forums.Readarr.tv/), [subreddit](https://www.reddit.com/r/Readarr/), [discord](https://discord.gg/Ex7FmFK), or [IRC](https://web.libera.chat/?channels=#Readarr) if you have any questions
